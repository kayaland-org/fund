...
contract UniV3LiquidityStaker is UniV3Liquidity {
    ...
    //Working positions
    EnumerableSet.UintSet private stakers;
    ...
    function safeApproveAll(address token) public override onlyStrategistOrGovernance {
        super.safeApproveAll(token);
