...
interface IFeeManager {
    ...
    /// @dev The fee is calculate by ratio of the fund amount
    /// @param ft Fee type
    /// @param fundAmount Fund amount
    function calcRatioFee(SmartPoolStorage.FeeType ft,uint256 fundAmount)external view returns(uint256);
